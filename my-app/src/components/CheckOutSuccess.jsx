...
const CheckoutSuccess = () => {
  ...
  // Bây giờ bạn có thể sử dụng cartItems ở đây
  console.log(cartItems);
  function getTotalPrice( cartItems ) {
    // Hàm để tính tổng giá tiền của từng món trong giỏ hàng
    const ship = 25000;
      let totalPrice = 0;
      let preship = 0;
  ...
  // Khai báo state cho các trường dữ liệu của form
  ...
  // Xử lý thay đổi của trường dữ liệu
  ...
  return (
    ...
    <main className=" w-screen min-h-screen items-center justify-center ">
      <h1 className="text-6xl text-orange-600 w-fit mx-auto">Thanh toán
      </h1>
      ...
      <ul className="flex flex-col gap-5 divide-y divide-gray-400">
        {cartItems.map((item, index) => (
          <li className="items-center pl-10 flex gap-3" key={index}>
            ...
            <p>Giá tiền: {item.price} 
            <span className="text-lg ml-2 text-white">VND</span></p>
            </div>
          </li>
        ))}
      </ul>
        ...
        {/* Hiển thị tổng giá tiền của từng món */}
      ...
      <div className=" w-1/2  bg-gradient-to-l from-orange-300 to-orange-500 flex flex-col ">
          ...
          <div className=""> 
        <h1 className="text-3xl text-white p-3 w-fit font-bold mx-auto border-b-2 border-black">
        ...
        name="email"
              ...
              <div className="h-[5rem]">
                <div className="flex justify-center items-center">
                  ...
                  >
                    <button
                      className="flex justify-center items-center text-white xl:w-48 h-10 shadow-lg shadow-orange-500/40 hover:text-black"
                    >
